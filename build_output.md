...
obs@grex-tcd-birr:~/grex$ ./build.sh
   ...
   Compiling mutually_exclusive_features v0.0.3
   ...
   Compiling hdf5-sys v0.8.1 (https://github.com/aldanor/hdf5-rust#43015dda)
   ...
   Compiling psrdada-sys v0.4.0
   Compiling tokio-util v0.7.11
   Compiling tokio-stream v0.1.15
   Compiling tokio-io-timeout v1.2.0
   Compiling actix-rt v2.10.0
   Compiling rsntp v4.0.0
   Compiling actix-server v2.4.0
   Compiling h2 v0.3.26
   Compiling tower v0.4.13
   Compiling actix-codec v0.5.2
   Compiling serde_urlencoded v0.7.1
   Compiling hifitime v3.9.0
error: failed to run custom build command for `psrdada-sys v0.4.0`

Caused by:
  process didn't exit successfully: `/home/obs/grex/t0/target/release/build/psrdada-sys-89171be1dab022e9/build-script-build` (exit status: 101)
  --- stdout
  cargo:rerun-if-env-changed=PSRDADA_NO_PKG_CONFIG
  cargo:rerun-if-env-changed=PKG_CONFIG_x86_64-unknown-linux-gnu
  cargo:rerun-if-env-changed=PKG_CONFIG_x86_64_unknown_linux_gnu
  cargo:rerun-if-env-changed=HOST_PKG_CONFIG
  cargo:rerun-if-env-changed=PKG_CONFIG
  cargo:rerun-if-env-changed=PSRDADA_STATIC
  cargo:rerun-if-env-changed=PSRDADA_DYNAMIC
  ...
  cargo:rustc-link-lib=psrdada
  cargo:rustc-link-search=native=/usr/local/cuda-12.5/lib64
  ...
  --- stderr
  /usr/include/x86_64-linux-gnu/sys/syslog.h:37:10: fatal error: 'stdarg.h' file not found
  thread 'main' panicked at /home/obs/.cargo/registry/src/index.crates.io-6f17d22bba15001f/psrdada-sys-0.4.0/build.rs:26:10:
  Unable to generate bindings: ClangDiagnostic("/usr/include/x86_64-linux-gnu/sys/syslog.h:37:10: fatal error: 'stdarg.h' file not found\n")
...
warning: build failed, waiting for other jobs to finish...
   ...
   Compiling pulp-macro v0.1.1
   Compiling tracing-attributes v0.1.27
   Compiling serde_derive v1.0.199
   Compiling equator-macro v0.1.9
   Compiling clap_derive v4.5.4
   Compiling pulp v0.18.10
   Compiling equator v0.1.10
   ...
   Compiling faer-entity v0.18.0
   Compiling nanstats v0.1.0 (https://github.com/kiranshila/nanstats#fb13cc5c)
   ...
   Compiling faer v0.18.2
error: failed to run custom build command for `psrdada-sys v0.4.0`

Caused by:
  process didn't exit successfully: `/home/obs/grex/clean_rfi/target/release/build/psrdada-sys-2a19d9d57c28823f/build-script-build` (exit status: 101)
  --- stdout
  cargo:rerun-if-env-changed=PSRDADA_NO_PKG_CONFIG
  cargo:rerun-if-env-changed=PKG_CONFIG_x86_64-unknown-linux-gnu
  cargo:rerun-if-env-changed=PKG_CONFIG_x86_64_unknown_linux_gnu
...
Installing the current project: grex_t2 (0.1.0)
Installing dependencies from lock file

Package operations: 0 installs, 1 update, 0 removals

  - Downgrading casperfpga (0.4.4.dev1348+master.4318d6e 4318d6e -> 0.4.4.dev1348+head.4318d6e 4318d6e)

Installing the current project: snap_bringup (0.1.0)
```
